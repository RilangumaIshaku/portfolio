...
export function ServicesSection({
  ...
  const add = () => {
    const n = [
      ...list,
      { title: "New Service", description: "Description.", icon: "Globe" },
    ];
    setList(n);
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-white/30 mt-1">
          The services you offer. Each card on the landing page.
        </p>
      </div>
            ...
            <div className="p-4 space-y-3">
              ...
              <Field label="Description">
                <TextArea
                  ...
                  onChange={(v) => update(i, { ...item, description: v })}
                  rows={2}
                />
              </Field>
              <Field label="Icon">
                ...
                >
                  {ICON_OPTIONS.map((ic) => (
                    <option key={ic} value={ic} className="bg-[#0c0c0c]">
                      {ic}
                    </option>
                  ))}
                </select>
