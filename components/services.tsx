          ...
          {services.map((service: any, i: number) => {
            ...
            return (
              <div
                key={service.title}
                className={cn(
                  "group relative bg-surface-elevated p-7 md:p-8 flex flex-col transition-all duration-500",
                  "hover:bg-muted/40",
                  isInView
                    ? "opacity-100"
                    : "opacity-0"
              ...
              >
                ...
                <div
                  ...
                  style={{ background: `radial-gradient(ellipse at 30% 20%, ${accent.muted} 0%, transparent 70%)` }}
                />
                {/* Always-visible subtle tint at top-left */}
                <div
                  className="absolute inset-0 pointer-events-none"
                  style={{ background: `radial-gradient(ellipse at 20% 10%, ${accent.muted.replace('0.12', '0.06')} 0%, transparent 60%)` }}
                />
                ...
                <div className="relative flex items-center justify-between mb-4">
                  <span
                    ...
                    style={{ color: `color-mix(in srgb, ${accent.color} 35%, #78716c)` }}
                  >
                    {number}
                  </span>
                  <ArrowRight
                ...
                <div
                  ...
                  style={{ background: `linear-gradient(90deg, transparent 0%, ${accent.color}30 50%, transparent 100%)` }}
                />
              </div>
            );
          })}
