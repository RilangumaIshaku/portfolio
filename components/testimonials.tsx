...
export function Testimonials({
  ...
  const testimonials =
    initialData && initialData.length > 0 ? initialData : data.testimonials;
  ...
  return (
    <section className="relative py-14 md:py-20 bg-surface overflow-hidden">
      ...
      <div
        className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/4 w-[800px] h-[400px] rounded-full blur-[120px] pointer-events-none"
        style={{
          background:
            "radial-gradient(ellipse at center, rgba(155, 143, 188, 0.10) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative section-container section-padding mb-8 md:mb-10">
          ...
          title={
            <>
              ...
              <span className="relative inline-block">
                <span className="text-muted-foreground/50 line-through decoration-2 text-[0.85em]">
                  clients
                </span>{" "}
        ...
        <div className="flex justify-center -mt-8 mb-8 md:-mt-10 md:mb-10">
          <div
            ...
            style={{ background: "var(--accent-lilac)", opacity: 0.5 }}
          />
        </div>
      </div>
